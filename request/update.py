...
def new():
    """
    This function download newest apods to database and then check in every 15 minutes if newest apod is available.
    """
...
def old():
    """
    This function allows to dowload older apods by typing date and period.
    """
